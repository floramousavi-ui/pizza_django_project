...
The App initially contains following five models:
* Pizza
* Topping
* Drink
* Order
...
## Database Design
The pizza App database has following 6 core models:
...
* **PizzaSize** --> stores sizes like Small, Medium, Large
...
* One PizzaSize can belong to many pizzas 
...
**Note**: The assignment says deleting menu items should not break past orders. So order items should store a snapshot of important data such as item name and price at the time of purchase.
